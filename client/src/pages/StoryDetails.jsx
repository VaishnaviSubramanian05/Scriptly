...
const [comments, setComments] = useState([]);
  ...
  useEffect(() => {
    ...
    fetch(`https://scriptly-f836.onrender.com/blogs/${id}`)
  ...
  fetch(
    `https://scriptly-f836.onrender.com/comments/${id}`
  )
...
<div className="mt-10">
  ...
  const res = await fetch(
    "https://scriptly-f836.onrender.com/comments",
    {
      ...
      ? (
        ...
        <button
          ...
          onClick={async () => {
            ...
            await fetch(
              `https://scriptly-f836.onrender.com/comments/${item._id}`,
              {
                method: "DELETE",
              }
            );
